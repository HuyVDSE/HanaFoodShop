...
import huyvd.tblPaymentMethod.TblPaymentMethodDAO;
import huyvd.tblPaymentMethod.TblPaymentMethodDTO;
...
public class ViewCartServlet extends HttpServlet {
	...
	try {
		...
		if (cart != null) {
		    ...
		    dao.loadPaymentMethod();
		    List<TblPaymentMethodDTO> listPaymentMethod = dao.getListPaymentMethod();
		    request.setAttribute("LIST_PAYMENT_METHOD", listPaymentMethod);
		}
	    }//end if session is exist
	} catch (SQLException | NamingException e) {
	    log("ViewCartServlet _ Exception: " + e.getMessage());
	} finally {
