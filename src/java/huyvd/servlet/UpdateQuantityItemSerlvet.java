 ...
 * @author BlankSpace
 */
@WebServlet(name = "UpdateQuantityItemSerlvet", urlPatterns = {"/UpdateQuantityItemSerlvet"})
public class UpdateQuantityItemSerlvet extends HttpServlet {
	...
	try {
		...
		if (cart != null) {
		    cart.updateQuantityOfItem(itemId, quantity);
		    session.setAttribute("CUS_CART", cart);
		}//end if cart exist
	    }//end if session exist
	} catch (NumberFormatException e) {
	    log("UpdateQuantityItemSerlvet _ NumberFormatException: " + e.getMessage());
	} finally {
